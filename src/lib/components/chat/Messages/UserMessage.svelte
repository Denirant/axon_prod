<script lang="ts">
	...
	import { Clipboard, PencilIcon } from 'lucide-svelte';
			...
			<div>
				<Name>
					...
					{#if message.timestamp}
						<div
							class=" self-center text-[10px] invisible group-hover:visible text-gray-300 font-normal first-letter:capitalize ml-0.5 translate-y-[1px]"
						>
					...
					<div class="w-full">
						...
						>
							...
							<Tooltip content={$i18n.t('Copy')} placement="bottom">
								<button
									class="ml-1 invisible group-hover:visible p-1.5 hover:bg-black/5 dark:hover:bg-white/5 rounded-lg dark:hover:text-white hover:text-black transition"
									on:click={() => {
